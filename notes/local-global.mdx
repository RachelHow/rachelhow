...
After optimising the system by applying [First Principles](/notes/first-principles) together with Local or Global, we apply [Regret Minimisation](/notes/regret-minimisation) to make better decisions.